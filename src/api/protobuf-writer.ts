...
export const temporal = (xn_milliseconds: Nilable<number>): Uint8Array<ArrayBuffer> => xn_milliseconds? Protobuf()
	.v((xn_milliseconds / 1e3) | 0)
	.v((xn_milliseconds % 1e3) * 1e6)
	.o: ATU8_NIL;

export const any = (si_type: string, atu8_value: Uint8Array): Uint8Array<ArrayBuffer> => Protobuf()
	.s(si_type)
	.b(atu8_value)
	.o;
...
>(a_coin: a_coin): Uint8Array<ArrayBuffer> | PropagateUndefined<a_coin> => (
	a_coin
		? Protobuf()
			.s(a_coin[1])
			.s(a_coin[0])
			.o
		: __UNDEFINED
) as Uint8Array<ArrayBuffer> | PropagateUndefined<a_coin>;

export const coins = (a_coins: Nilable<SlimCoin[]>): Uint8Array<ArrayBuffer>[] | undefined => map(a_coins, coin);
